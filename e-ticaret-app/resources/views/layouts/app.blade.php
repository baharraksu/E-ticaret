...
<head>
    ...
    <!-- Vite kaldırıldı - Bootstrap CDN kullanılıyor -->
</head>
<body>
    <!-- Navigation -->
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container">
            <a class="navbar-brand" href="{{ route('home') }}">
                <i class="fas fa-shopping-cart me-2"></i>E-Ticaret
            </a>
    ...
    <footer class="bg-dark text-light py-4 mt-5">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <h5>E-Ticaret Sitesi</h5>
                    <p>Redis ve Laravel ile geliştirilmiş modern e-ticaret platformu.</p>
                </div>
